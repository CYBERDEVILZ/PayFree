...
class QRScannedPage extends StatefulWidget {
  const QRScannedPage({Key? key, required this.amount, required this.upi, required this.name}) : super(key: key);
...
class _QRScannedPageState extends State<QRScannedPage> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.name.isNotEmpty) {
      a = widget.name.split(" ")[0][0].toUpperCase();
      if (widget.name.split(" ").length > 1) {
        b = widget.name.split(" ")[1][0].toUpperCase();
      }
    }
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    widget.name.isEmpty ? "Null" : widget.name,
