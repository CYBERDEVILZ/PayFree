...
class BackMess extends StatefulWidget {
  const BackMess({Key? key, required this.amount}) : super(key: key);

  final String recv = "Cook House Amity University";
  final String recvVerified = "Cook House";
  final String? amount;

  @override
  State<BackMess> createState() => _BackMessState();
}

class _BackMessState extends State<BackMess> {
